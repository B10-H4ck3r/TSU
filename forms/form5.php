<!-- Start Div Block for Form 5 -->
<div class="form_div" id="Form5Div" style="display: none;">
  ...
  <button type="button" class="btn btn-lg btn-success" style="font-family: 'Cinzel', serif;">Download Form 5</button><br/>
  <br/>
