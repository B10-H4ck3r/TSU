<!-- Start Div Block for Form 6 -->
<div class="form_div" id="Form6Div" style="display: none;">
  ...
  <button type="button" class="btn btn-lg btn-success" style="font-family: 'Cinzel', serif;">Download Form 6</button><br/>
  <br/>
