<!-- Start Div Block for Form 3 -->
<div class="form_div" id="Form3Div" style="display: none">
  ...
  <button type="button" class="btn btn-lg btn-danger" style="font-family: 'Cinzel', serif;">Download Form 3</button><br/>
  <br/>
